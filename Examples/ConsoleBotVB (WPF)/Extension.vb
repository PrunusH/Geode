...
Public Class Extension
    ...
    Public WithEvents Ext As GeodeExtension
    ...
    Public Sub New(MainWindowParent As MainWindow)
        ...
        Ext = New GeodeExtension("ConsoleBotVB", "Geode examples.", "Lilith", True, False) 'Instantiate extension
    ...
    Private Sub Ext_OnDataInterceptEvent(sender As Object, e As DataInterceptedEventArgs) Handles Ext.OnDataInterceptEvent
        If e.Packet.Id = Ext.In.FriendRequests.Id Then 'Show Bot when the initial console load is complete.
            BotShowAndWelcome()
        End If
    End Sub

    Private Sub Ext_OnDoubleClickEvent(sender As Object, e As HPacket) Handles Ext.OnDoubleClickEvent 'G-Earth extension play button clicked.
        If Ext.IsConnected Then
            BotShowAndWelcome()
        End If
    End Sub

    Private Sub Ext_OnConnectedEvent(sender As Object, e As HPacket) Handles Ext.OnConnectedEvent 'G-Earth is connected.
        BotShowAndWelcome()
    End Sub

    Private Sub Ext_OnCriticalErrorEvent(sender As Object, e As String) Handles Ext.OnCriticalErrorEvent 'G-Earth is probably closed or the connection was rejected.
